                ...
                <Form.Row>
                    ...
                    <Col lg={6} xl={4}>
                        <Form.Group>
                            ...
                            <InputGroup 
                                className="mb-3"
                                onClick={() => this.copyToClipboard(`https://weebecash.ngrok.io/signup?referral=${activeUser!.username}`)}
                            >
                                <Form.Control 
                                    value={`https://weebecash.ngrok.io/signup?referral=${activeUser!.username}`} 
                                    disabled={true}
