...
export const apiReplyNotification: ApiReplyNotification = {
    ...
    "title": "",
    "body": "Testing replies from Weebecash web interface \ud83d\ude0e",
